...
export function externalLink({ className, ...rest }: LucideIconProps) {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			viewBox="0 0 24 24"
...
export function menu({ className, ...rest }: LucideIconProps) {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			viewBox="0 0 24 24"
...
export function zoomIn({ className, ...rest }: LucideIconProps = {}) {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			viewBox="0 0 24 24"
...
export function zoomOut({ className, ...rest }: LucideIconProps = {}) {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			viewBox="0 0 24 24"
